...
To install this plugin, copy the GR544P.suprx file to ur0:tai/ folder on your modded vita, then enter your config file and add the following lines corresponding to your region so that the plugin will launch with the game
e.g.
*PCSA00011
